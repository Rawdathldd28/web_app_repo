    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Main open={open}>
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100vh' }}>
          <div style={{ width: '100%', height: '800px', backgroundColor: 'white', marginTop: '40px' }}>
            <Box
              component="main"
              sx={{ flexGrow: 1, p: 3, marginTop: 2, }}
            >
              <Toolbar />
              <p style={{ fontWeight: 'bold', fontSize: '25px', textAlign: 'center', margin: 'auto', color: '#234060', marginTop: '-100px' }}>
                <strong>
                  RESERVATION ACCUEIL VIP ALLER-RETOUR
                </strong>
              </p>

              <p style={{ fontSize: '20px' }}>Tarif d'accueil a l'aeroport de <strong> Sabiha Gokcen (SAW) Arrivee </strong> a <strong>Istanbul</strong> est de <strong> 390 euros </strong> par personne. Le passager supplementaire sera facture a <strong> 390 euros.</strong></p>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '8px' }}>
                ...
                <TextField
                  type="text"
                  placeholder="Entrez votre numeros de vol"
                  variant="outlined"
                  fullWidth
                  InputProps={{
                    startAdornment: (
              ...
              <p style={{ fontSize: '20px' }}><strong> A propos du vol</strong></p>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px' }}>
                <TextField
                  type="text"
                  placeholder="Entrez votre compagnie"
                  variant="outlined"
                  fullWidth
                />
                <TextField
                  type="text"
                  placeholder="Entrez votre billet"
                  variant="outlined"
                  fullWidth
                />
                <TextField
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px' }}>
                ...
                <TextField
                  type="text"
                  placeholder="Entrez votre date d'arrive"
                  variant="outlined"
                  fullWidth
                />
                <TextField
                  type="text"
                  placeholder="Entrez votre heure d'arrive"
                  variant="outlined"
                  fullWidth
                />
                <TextField
                  type="text"
                  placeholder="Entrez votre date de retour"
                  variant="outlined"
                  fullWidth
                />
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px' }}>
                <TextField
                  type="text"
                  placeholder="Entrez votre heure"
                  variant="outlined"
                  fullWidth
                />
              </div>
