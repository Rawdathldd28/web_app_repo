...
const ContactForm = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // Utilisez votre endpoint formspree ici
      const formspreeEndpoint = 'https://formspree.io/f/xayrqykr';
    ...
    <div className="bg-white dark:bg-gray-900">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">
          Branchez-vous sur l'avenir : Soumettez votre projet dès maintenant ! Besoin de détails sur notre plan d'affaires ? Faites-le nous savoir.
        </p>
